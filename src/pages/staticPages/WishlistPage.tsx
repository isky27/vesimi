									...
									<div className="position-relative">
										...
										<div className="QuickView">
											...
											<div className="AddProductAction">
												...
												<button style={{color:"bb3d1f"}} className="border-0">BUY NOW</button>
											</div>
