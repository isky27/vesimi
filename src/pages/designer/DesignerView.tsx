        ...
        <main className="pageMain">
            <div className="container">
                <div className="pageHead">
                    <nav aria-label="breadcrumb" className=" ">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Designers</li>
                        </ol>
                    </nav>
                ...
                <div className="categoeryLink">
                    ...
                    <Link to={"/"}>Vaani Beswal</Link>
                </div>

                <div className="categoerySidebarMain">
                    <div className="categoerySidebar">
                        <ul className="Playfair">
                            <li><Link to={"/"}>All Designers</Link></li>
                            <li><Link to={"/"}>Clothing Designers</Link></li>
                            <li><Link to={"/"}>Accessories Designers </Link></li>
                            <li><Link to={"/"}>Jewellery Designers</Link></li>
                            <li><Link to={"/"}>Popular Designers</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="categoeryRightBar">
                        ...
                        <div className="TabRedirec">
                            <a href="#AFor">A</a><a href="#bFor">b</a><a href="#cFor">c</a><a href="#dFor">d</a><a href="#eFor">e</a><a href="#fFor">f</a><a href="#gFor">g</a><a href="#hFor">h</a><a href="#iFor">i</a>
                            <a href="#jFor">j</a><a href="#kFor">k</a><a href="#lFor">l</a><a href="#mFor">m</a><a href="#nFor">n</a><a href="#oFor">o</a><a href="#pFor">p</a><a href="#qFor">q</a><a href="#rFor">r</a>
                            <a href="#sFor">s</a><a href="#tFor">t</a><a href="#uFor">u</a><a href="#vFor">v</a><a href="#wFor">w</a><a href="#xFor">x</a><a href="#yFor">y</a><a href="#zFor">z</a>
                        </div>
                        ...
                        <div className="accordion accordion-flush" id="accordionFlushExample">
                            ...
                            <div className="accordion-item" id="dFor">
                                <h2 className="accordion-header" id="accordion0">
                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faccordian3" aria-expanded="false" aria-controls="faccordian3">
                                        D
                                    </button>
                                </h2>
                                <div id="faccordian3" className="accordion-collapse collapse" aria-labelledby="faccordian1" data-bs-parent="#accordionFlushExample">
                                    <div className="accordion-body">
                                        <div className="categoeryLink">
                            ...
                            <div className="accordion-item" id="eFor">
                                <h2 className="accordion-header" id="accordion">
                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faccordian4" aria-expanded="false" aria-controls="faccordian4">
                                        E
                                    </button>
                                </h2>
                                <div id="faccordian4" className="accordion-collapse collapse" aria-labelledby="faccordian1" data-bs-parent="#accordionFlushExample">
                                    <div className="accordion-body">
                                        <div className="categoeryLink">
                                            <Link to={"/"}>Eariyana Couture</Link>
                                            <Link to={"/"}>E Clutch Story</Link>
                            ...
                            <div className="accordion-item" id="fFor">
                                <h2 className="accordion-header" id="accordion2">
                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faccordian5" aria-expanded="false" aria-controls="faccordian5">
                                        F
                                    </button>
                                </h2>
                                <div id="faccordian5" className="accordion-collapse collapse" aria-labelledby="faccordian1" data-bs-parent="#accordionFlushExample">
                                    <div className="accordion-body">
                                        <div className="categoeryLink">
                            ...
                            <div className="accordion-item" id="gFor">
                                <h2 className="accordion-header" id="accordion3">
                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faccordian6" aria-expanded="false" aria-controls="faccordian6">
                                        G
                                    </button>
                                </h2>
                                <div id="faccordian6" className="accordion-collapse collapse" aria-labelledby="faccordian1" data-bs-parent="#accordionFlushExample">
                                    <div className="accordion-body">
                                        <div className="categoeryLink">
                            ...
                            <div className="accordion-item" id="hFor">
                                <h2 className="accordion-header" id="accordion4">
                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faccordian7" aria-expanded="false" aria-controls="faccordian7">
                                        H
                                    </button>
                                </h2>
                                <div id="faccordian7" className="accordion-collapse collapse" aria-labelledby="faccordian1" data-bs-parent="#accordionFlushExample">
                                    <div className="accordion-body">
                                        <div className="categoeryLink">
                            ...
                            <div className="accordion-item" id="iFor">
                                <h2 className="accordion-header" id="accordion5">
                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faccordian8" aria-expanded="false" aria-controls="faccordian8">
                                        I
                                    </button>
                                </h2>
                                <div id="faccordian8" className="accordion-collapse collapse" aria-labelledby="faccordian1" data-bs-parent="#accordionFlushExample">
                                    <div className="accordion-body">
                                        <div className="categoeryLink">
                            ...
                            <div className="accordion-item" id="jFor">
                                <h2 className="accordion-header" id="accordion6">
                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faccordian9" aria-expanded="false" aria-controls="faccordian9">
                                        J
                                    </button>
                                </h2>
                                <div id="faccordian9" className="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div className="accordion-body">
                                        <div className="categoeryLink">
                            ...
                            <div className="accordion-item" id="kFor">
                                <h2 className="accordion-header" id="accordion7">
                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faccordian10" aria-expanded="false" aria-controls="faccordian10">
                                        K
                                    </button>
                                </h2>
                                <div id="faccordian10" className="accordion-collapse collapse" aria-labelledby="faccordian11" data-bs-parent="#accordionFlushExample">
                                    <div className="accordion-body">
                                        <div className="categoeryLink">
                            ...
                            <div className="accordion-item" id="lFor">
                                <h2 className="accordion-header" id="accordion8">
                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faccordian12" aria-expanded="false" aria-controls="faccordian12">
                                        L
                                    </button>
                                </h2>
                                <div id="faccordian12" className="accordion-collapse collapse" aria-labelledby="faccordian11" data-bs-parent="#accordionFlushExample">
                                    <div className="accordion-body">
                                        <div className="categoeryLink">
